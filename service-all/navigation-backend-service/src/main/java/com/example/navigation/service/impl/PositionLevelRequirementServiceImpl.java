...
public class PositionLevelRequirementServiceImpl implements PositionLevelRequirementService {
    ...
    public PositionLevelRequirementServiceImpl(PositionLevelRequirementRepository positionLevelRequirementRepository,PositionLevelRepository positionLevelRepository) {
    ...
    public List<PositionLevelRequirementInfo> findAllPositionsWithCertificates() {
        ...
        for (PositionLevel position : positions) {
            ...
            List<PositionLevelRequirement> requirements =
                    positionLevelRequirementRepository.findByPositionLevel_PositionId(position.getPositionId());
